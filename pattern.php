    ...
    <div class="mhn-ui-wrap">
        ...
        <div class="mhn-ui-page page-home">
            ...
            <div class="mhn-ui-app-title-head">
                <span class="mhn-ui-page-title">CAPTCHA</span>
                <div class="mhn-ui-info">Prove you are not a robot/ bot :)<input type="button" id="next" name="next" value="Go to CAPTCHA"  onclick="window.location.href='captcha/index.php'"> </div>
            </div>
        </div>
    </div>

...
<head>
    ...
    <script type="text/javascript" src="js/patternlock.es.js"></script>
...
<body >
    ...
    <div class="mhn-ui-wrap">
        <div class="mhn-ui-page page-lock">
            ...
            <div class="mhn-lock-wrap">
                <h1>Login</h1>
                <div class="mhn-lock-title" data-title=""></div>
                <div>
                    <form action="#" method="POST">
                        <div class="login-box">
                            ...
                            <input type="button" id="btnlog" class="btn"  name="login" value="Log In">
                            <br><br>
                            <a href="#">Don't rememeber the Password?</a><br>
    ...
    <div class="mhn-ui-info">Please Enter your User name and password :)</div>
